...
## 영수증 촬영과 사진 업로드
홈과 구매 추가에서 두 입력 버튼을 제공하며 동일한 검증/분석 경로를 사용한다. 식품/비식품/애매한 품목을 나누고 후보 확인 후 일괄 등록한다. 현재 실제 이미지 인식·웹 검색은 없으며 로컬 Mock 예시다. 제출 준비 범위는 docs/TOP20_READINESS.md 참조.
